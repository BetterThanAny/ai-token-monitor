...
macOS ve Windows sistem tepsisinde **Claude Code** ve **Codex** token kullanımını, maliyetini ve etkinliğini gerçek zamanlı olarak izleyen bir uygulamadır. Liderlik tablosu, sohbet ve webhook bildirimleri tek bir ekranda sunulur.
